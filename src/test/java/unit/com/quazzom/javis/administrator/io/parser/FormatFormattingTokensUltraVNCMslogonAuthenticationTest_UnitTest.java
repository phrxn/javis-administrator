...
import com.quazzom.javis.administrator.io.parser.FormatFormattingTokensUltraVNCMslogonAuthentication;
...
public class FormatFormattingTokensUltraVNCMslogonAuthenticationTest_UnitTest {
  ...
  public void testReplaceFormattingTokensByWords_listWithoutHost() {
    ...
    FormatFormattingTokensUltraVNCMslogonAuthentication ffta =
        new FormatFormattingTokensUltraVNCMslogonAuthentication("", "", "", "", theLanguage);

    List<Token> listOfTokensFormat = new ArrayList<Token>();
    listOfTokensFormat.add(new Token(TypeOfToken.PORT, "port"));
    listOfTokensFormat.add(new Token(TypeOfToken.USER, "user"));
  ...
  @Test
  public void testReplaceFormattingTokensByWords_listWithoutUser() {

    Text theLanguage = Mockito.mock(Text.class);
    when(theLanguage.getText("FORMATTING_TOKEN_FOMATTER_MISSING_EXCEPTION", "\\user"))
        .thenReturn("x");
  ...
  public void testReplaceFormattingTokensByWords_replaceOneTokenEach() throws GrammarException {
    ...
    FormatFormattingTokensUltraVNCMslogonAuthentication ffta =
        new FormatFormattingTokensUltraVNCMslogonAuthentication(
            "zzzz", "9090", "john.lennon", "123!132", theLanguage);
    ...
    listToCompare.add(new Token(TypeOfToken.WORD, "john.lennon"));
