...
public class FormatFormattingTokensVNCAuthentication implements FormatFormattingTokens {
  ...
  public FormatFormattingTokensVNCAuthentication(
      String theHost, String thePort, String thePassword) {
    this(
        theHost,
        thePort,
        thePassword,
        LanguageFactory.getLanguage(
            LanguagePathToFile.FORMAT_FORMATTING_TOKENS_VNC_AUTHENTICATION));
  }

  public FormatFormattingTokensVNCAuthentication(
      String theHost, String thePort, String thePassword, Text theLanguage) {
